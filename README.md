...
<head>
  ...
  <style>
    *{margin:0;box-sizing:border-box}
    ...
    .links a{display:block;margin:12px auto;padding:14px 24px;max-width:280px;color:white;border-radius:50px;text-decoration:none;font-weight:600;font-size:1.05rem;transition:.3s;box-shadow:0 4px 15px rgba(0,0,0,0.4)}
    .links a:hover{transform:translateY(-3px);box-shadow:0 8px 25px rgba(0,0,0,0.6)}
    ...
    .links a:nth-child(4){background:#7b68ee}        /* Projeto */
  </style>
</head>
<body>
  <div class="card">
